  ...
  <div className="modal-box">
    ...
    <div className='mt-4 space-y-2'>
        ...
        <div className='flex justify-around mt-4'>
            ...
            <span className='text-xl'> Already Have an account?{" "} <button  className='underline text-blue-500 cursor-pointer' onClick={()=>document.getElementById("my_modal_3").showModal()}>Login</button>{" "}<Login/></span>
        </div>
